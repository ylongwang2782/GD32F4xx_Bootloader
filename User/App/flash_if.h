...
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
/* Base address of the Flash sectors for GD32F4xx (2MB Flash) */
...
/* Define the address from where user application will be loaded.
   Note: the 1st two sectors 0x08000000-0x08007FFF are reserved for the IAP code */
#define APPLICATION_ADDRESS   (uint32_t)0x08008000

/* Define bitmap representing user flash area that could be write protected for GD32F4xx */
#define FLASH_SECTOR_TO_BE_PROTECTED (OB_WRP_SECTOR_2 | OB_WRP_SECTOR_3 | OB_WRP_SECTOR_4 | OB_WRP_SECTOR_5 |\
